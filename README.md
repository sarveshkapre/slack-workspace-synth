...
Create a synthetic Slack-like workspace with ~2,000 users, channels, messages, and files for demos, load testing, or analytics prototyping. Data is deterministic by seed, stored in SQLite, and served via an optional read-only API. Extend generation using a simple plug-in hook API.
